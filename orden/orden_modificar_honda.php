...
o.abono,o.estado,cli.email,cli.idcliente 
  ...
  <table border = "1" width = "75%" class="sombra">
      ...
      <tr>
	  	...
	  	<td>      
           ...
           echo '<input type="text" size=20 name="abono" id = "abono"  value= "'.$datos[0]['abono'].'"  ;>';
          
           } 
           else{
                echo '<input type="hidden"  size=20 name="abono" id = "abono"  value= "'.$datos[0]['abono'].'"  ;>';
                 echo $datos[0]['abono'];
           }
           ?>
...
if($_SESSION['id_usuario']==13){
  ...
  <?php
  } //fin de si es usuario id=13

  else {
       //echo '<input type="text"  id="ultimo_estado"  value="'.$datos[0]['estado'] .'">';
       //$nombre_estado12 = busque_estado($tabla26,$datos[0]['estado'],$_SESSION['id_empresa'],$conexion);
       //echo $nombre_estado12 ;
       echo   '<select name = "ultimo_estado" id = "ultimo_estado">';
 
       echo  '<option value = "'.$datos[0]['estado'].'" selected ></option>';
  ...
  <tr>
  <td colspan= "2">  <h2> <input name="enviar_correo" id="enviar_correo" type="checkbox" value="1" id = "enviar_correo" >
       <label  for ="enviar_correo" >Enviar Correo al Cliente </label></h2></td>
  </tr>  
