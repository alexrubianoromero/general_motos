...
{	$sql_muestre_ordenes .= " and c.propietario = '".$_REQUEST['idcliente']."'";
}

$sql_muestre_ordenes .=  " order by o.id desc   ";
...
echo '<table border= "1">';
	echo '<tr>';
	echo '<td><h3>No Orden123<h3></td><td><h3>Estado</h3></td><td><h3>Linea</h3></td><td><h3>Fecha</h3></td><td><h3>Placa</h3></td>';
