...
//{
      $body .='Te damos la bienvenida a GENERAL MOTOS
De antemano queremos agradecer tu confianza en nosotros, y en respuesta a ello hemos dispuesto de los mejores profesionales, insumos y experiencia, para satisfacer completamente tus requerimientos hacia nuestro servicio. ';
//}

$ordenpan= $_REQUEST['orden_numero'];

$body .='
Hemos creado una orden con la siguiente informacion. 
Placa: '.$_REQUEST['placa'].' Orden No : '.$ordenpan.' 
